  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100 tracking-tight">Dashboard Member</h1>
          <p className="text-slate-600 dark:text-slate-400 mt-1">Selamat datang, {user.username}!</p>
        </div>
        <button 
          onClick={handleLogout} 
          className="px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-full text-sm font-semibold shadow-sm hover:shadow-md transition-transform active:scale-95"
        >
          Logout
        </button>
      </div>
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl shadow-sm">
            ...
            <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl shadow-sm">
